...
public class MessageUserHasRegistered extends Server2Client {
	...
	public MessageUserHasRegistered(String username, int gameCounter, int winCounder, int secondPlaceCounter, int maxScore) {
